...
export const eventApi = {
  ...
  listRewardRules: (eventId) => client.get(`/events/${eventId}/reward-rules`),
  createRewardRule: (eventId, data) => client.post(`/events/${eventId}/reward-rules`, data),
  updateRewardRule: (eventId, ruleId, data) => client.patch(`/events/${eventId}/reward-rules/${ruleId}`, data),
  deleteRewardRule: (eventId, ruleId) => client.delete(`/events/${eventId}/reward-rules/${ruleId}`),
