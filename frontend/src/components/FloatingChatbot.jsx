  ...
  return (
    ...
    >
      {/* -------------------------------------------------------------
          ...
          ------------------------------------------------------------- */}
      <div className="bg-gradient-to-r from-[var(--palette-teal)] via-[#528976] to-[var(--palette-plum)] text-white p-3 sm:p-3.5 flex flex-col gap-2 shadow-sm select-none">
        {/* Mobile pull indicator bar */}
        <div className="sm:hidden flex justify-center -mt-1 -mb-0.5">
      ...
      {/* -------------------------------------------------------------
          Input Box & Controls
          ------------------------------------------------------------- */}
      <div className="p-2.5 pb-safe bg-[var(--color-bg-card)] border-t border-[var(--color-border)] flex gap-2 items-center">
        <textarea
          value={input}
